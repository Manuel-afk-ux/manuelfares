                ...
                <tbody>
                    <?php if (count($clientes) > 0) { ?>
                        <?php foreach ($clientes as $cliente) { ?>
                            <tr>
                                <td><?php echo htmlspecialchars($cliente["idcli"]); ?></td>
                                <td><?php echo htmlspecialchars($cliente["nomcli"]); ?></td>
                                <td><?php echo htmlspecialchars($cliente["direccion"]); ?></td>
                                <td><?php echo htmlspecialchars($cliente["telres_cli"]); ?></td>
                                <td><?php echo htmlspecialchars($cliente["telcel_cli"]); ?></td>
                                <td><?php echo htmlspecialchars($cliente["email_cli"]); ?></td>
                            </tr>
                        <?php } ?>
                    <?php } else { ?>
                        <tr>
